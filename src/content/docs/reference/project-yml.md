...
| `connectors` | list of `{package, version}` | empty | Non-builtin connector packages `pz restore` resolves. Builtin connectors ([localfiles](/connectors/localfiles/), [postgres](/connectors/postgres/), [s3](/connectors/s3/), [sqlserver](/connectors/sqlserver/), [azureblob](/connectors/azureblob/), [gcs](/connectors/gcs/), [http](/connectors/http/), [mysql](/connectors/mysql/), [sqlite](/connectors/sqlite/), [sftp](/connectors/sftp/)) need no entry. |
